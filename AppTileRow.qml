...
// everything else as the colored-glyph tile RootTileView.qml uses for plain
// menu entries — so one component serves all three Home sections instead of
        ...
        BorderSurface {
          ...
          Column {
            ...
            Item {
              ...
              // drop shadow — same technique RootTileView.qml uses to stay
